...
function PlanCards() {
  ...
  return (
    <div className='bg-white w-full py-[10rem] px-4'>
        <div className='max-w-[1240px] mx-auto grid grid-rows md:grid-cols-3 gap-8 '>  {/* border border-amber-400 */}
            <div className='w-full shadow-xl flex flex-col p-4 my-4 rounded-lg hover:scale-105 duration-300'> {/* border border-red-400 */}
            ...
            <div className='w-full shadow-xl bg-gray-100 flex flex-col p-4 my-8 md:my-0  rounded-lg hover:scale-105 duration-300 '> {/* border border-red-400 */}
